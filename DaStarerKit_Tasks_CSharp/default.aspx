<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="DaStarerKit_Tasks_CSharp._default" %>
...
<body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Hello, tasks!</h1>
        <p>This is a template for a simple started C# website using DasData channel.  </p>
        ...
        <div class="col-md-4">
          ...
          <p>
              ...
              Task status: <br />
               ...
               <p>  <asp:Button ID="btnSendTask" class="btn btn-default" runat="server" Text="Send task" OnClick="btnSendTask_Click" />   </p>
